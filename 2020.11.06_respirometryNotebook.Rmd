...
```{r 9.d Comparing the slopes of 58 and 59}
...
```{r 9.e Creating a small box plot for Krill 59}
...
```{r 9.f Creating a small box plot for Krill 68}
...
```{r 9.g Creating a small box plot for Krill 69}
