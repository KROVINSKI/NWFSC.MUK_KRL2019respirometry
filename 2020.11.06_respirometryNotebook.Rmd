...
##### 9.b Included Slope Value
```{r 9.a IncludedSlope Values}

IncludedINFOobservations <- (dtotal[dtotal$KrillID %in% names(info), ])
unique(IncludedINFOobservations$KrillID)
Incld_UniqueKrillIDs <- levels(IncludedINFOobservations$KrillID)
write.table(Incld_UniqueKrillIDs, file = "2020.11.09IncludedINFOobservationsKrillID.csv")

comparedf(Incld_UniqueKrillIDs, MissingINFOobservations)
summary.comparedf(Incld_UniqueKrillIDs, MissingINFOobservations)
